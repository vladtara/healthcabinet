				...
				<table class="hc-landing-preview-table" aria-label={copy.previewExampleAria}>
					...
					<tbody>
						...
						<tr>
							...
							<td class="hc-trend-down-bad"
								><span aria-label={copy.previewTrendDecreasing}>↓</span></td
							>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>12 – 150</td>
							<td class="hc-status-optimal">{copy.previewStatusOptimal}</td>
							<td class="hc-trend-up-good"
								><span aria-label={copy.previewTrendIncreasing}>↑</span></td
							>
						</tr>
					</tbody>
				</table>
